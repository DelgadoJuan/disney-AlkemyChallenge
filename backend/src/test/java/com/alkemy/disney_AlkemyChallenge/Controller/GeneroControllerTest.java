...
class GeneroControllerTest {
    ...
    void setup() {
        ...
        generoResponseDTO.setId(1L);
        generoResponseDTO.setNombre("Acción");
        generoResponseDTO.setImagen(directory + "accion.jpg");
        ...
        when(generoService.getGeneros()).thenReturn(List.of(generoResponseDTO));
    }

    @Test
    void getGenres() throws Exception {
        // Preparar datos de prueba
        GeneroResponseDTO genero = new GeneroResponseDTO();
        List<GeneroResponseDTO> generos = List.of(genero);
