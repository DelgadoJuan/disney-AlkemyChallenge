...
class PersonajeControllerTest {
    ...
    private PersonajeListDTO personajeListDTO;
    private PersonajePrintDTO personajePrintDTO;
    ...
    void getPersonaje() throws Exception {
        when(personajeService.getCharacter(1L)).thenReturn(Optional.of(personajePrintDTO));
    ...
    void getAllPersonajes() throws Exception {
        when(personajeService.charactersList()).thenReturn(List.of(
                new PersonajeListDTO(personajeEntity.getId(), personajeEntity.getNombre(), personajeEntity.getImagen(), personajeEntity.getEdad(), personajeEntity.getPeso()),
                new PersonajeListDTO(personajeEntity2.getId(), personajeEntity2.getNombre(), personajeEntity2.getImagen(), personajeEntity2.getEdad(), personajeEntity2.getPeso())
        ));
    ...
    void getCharactersByAudiovisual() throws Exception {
        when(personajeService.getCharactersByAudiovisual(1L)).thenReturn(List.of(personajeListDTO));
