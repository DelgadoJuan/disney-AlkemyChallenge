...
class AudiovisualServiceImplTest {
    ...
    void getAudiovisualsByOrder() {
        ...
        when(audiovisualEntityToAudiovisualPrintDTO.convert(audiovisualEntity)).thenReturn(audiovisualPrintDTO);
        when(audiovisualEntityToAudiovisualPrintDTO.convert(audiovisualEntity2)).thenReturn(audiovisualPrintDTO2);
    ...
    void getAudiovisual() {
        ...
        AudiovisualPrintDTO result = audiovisualService.getAudiovisual(1L);
    ...
    @Test
    void addAudiovisual() {
        when(audiovisualMapper.audiovisualDTOtoAudiovisualEntity(audiovisualDTO)).thenReturn(audiovisualEntity);
        when(audiovisualRepository.save(any(AudiovisualEntity.class))).thenReturn(audiovisualEntity);

        audiovisualService.addAudiovisual(audiovisualDTO);
    ...
    void deleteAudiovisual() {
        ...
        audiovisualService.deleteAudiovisual(1L);
    ...
    void updateAudiovisual() {
        ...
        audiovisualService.updateAudiovisual(1L, audiovisualDTO);
        verify(audiovisualRepository, times(1)).findById(1L);
        verify(audiovisualRepository, times(1)).save(any(AudiovisualEntity.class));
    }
    ...
    void addCharacter() {
        ...
        audiovisualService.addCharacter(1L, 1L);
        verify(audiovisualRepository, times(1)).findById(1L);
    ...
    void removeCharacter() {
        ...
        audiovisualService.removeCharacter(1L, 1L);
        verify(audiovisualRepository, times(1)).findById(1L);
        verify(personajeRepository, times(1)).findById(1L);
        verify(personajeRepository, times(1)).save(any(PersonajeEntity.class));
    }
    ...
    void updateGenre() {
        ...
        audiovisualService.updateGenre(1L, 1L);
        verify(audiovisualRepository, times(1)).findById(1L);
