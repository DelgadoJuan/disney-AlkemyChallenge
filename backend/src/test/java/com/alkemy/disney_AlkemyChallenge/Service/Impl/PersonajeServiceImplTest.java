...
class PersonajeServiceImplTest {
    ...
    void getCharacter() {
        ...
        Optional<PersonajePrintDTO> result = personajeService.getCharacter(1L);
    ...
    void getCharactersByAudiovisual() {
        ...
        List<PersonajeListDTO> result = personajeService.getCharactersByAudiovisual(1L);
        assertNotNull(result);
        assertEquals(2, result.size());
        assertEquals("Pato Donald", result.get(0).getNombre());
        assertEquals("Pato enojado", result.get(1).getNombre());
    ...
    void addCharacter() {
        ...
        when(personajeMapper.personajeDTOtoPersonajeEntity(personajeDTO)).thenReturn(personajeEntity);
